namespace fvcedit
{
	partial class FastgradientOptions
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FastgradientOptions));
			...
			this.fgColorB = new System.Windows.Forms.ColorDialog();
			this.fgColorA = new System.Windows.Forms.ColorDialog();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(77, 45);
			...
			// fgColorB
			// 
			this.fgColorB.AnyColor = true;
			this.fgColorB.Color = System.Drawing.Color.White;
			// 
			// fgColorA
			// 
			this.fgColorA.Color = System.Drawing.Color.White;
			// 
			// FastgradientOptions
			// 
			...
			this.Name = "FastgradientOptions";
			this.Text = "Fastgradient options";
		...
		public ColorDialog fgColorB;
		public ColorDialog fgColorA;
	}
}